...
function Bar({ label, value, max, isHighlight }) {
    const pct = max === 0 ? 0 : Math.round((value / max) * 100);
    return (
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
        <span style={{ color: '#9ca3af', fontSize: 13, width: 12, textAlign: 'right' }}>{label}</span>
        <div style={{ flex: 1, background: '#1f2937', borderRadius: 4, height: 24, overflow: 'hidden' }}>
            <motion.div
            initial={{ width: 0 }}
            ...
            style={{
                height: '100%',
                background: isHighlight ? '#538d4e' : '#374151',
                borderRadius: 4,
                display: 'flex',
                alignItems: 'center',
...
function StatBox({ label, value }) {
    return (
        ...
        <div style={{ fontSize: 32, fontWeight: 900, color: '#e5e7eb' }}>{value}</div>
...
function StatsPanel({ mode }) {
    ...
    return (
        ...
        <p style={{
            ...
            color: '#4b5563', marginBottom: 12, fontFamily: 'monospace',
        }}>
            Guess Distribution
        </p>
        {[1, 2, 3, 4, 5, 6].map(n => (
    ...
    return (
        ...
        >
            ...
            <p style={{
                ...
                color: '#6b7280', marginBottom: 20, fontFamily: 'monospace',
            }}>
                Statistics
            </p>
            <div style={{
                ...
                <button
                    ...
                    background: tab === t ? '#538d4e' : 'transparent',
